package edu.mayo.bsi.uima.stream.core.cr;


import edu.mayo.bsi.uima.stream.core.internal.COMMON;
import edu.mayo.bsi.uima.streaming.StreamingMetadata;
...
public class BlockingStreamCollectionReader extends JCasCollectionReader_ImplBase {
     ...
     * the stage in which {@link edu.mayo.bsi.uima.stream.core.cc.StreamResultHandlerCasConsumer} is ran.<br>
     * <br>
